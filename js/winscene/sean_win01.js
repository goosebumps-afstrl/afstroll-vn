export const seanWinStory = {
  startWinScene() {
    GAME.ui.initWinBars();
    return [
      {
        type: "image",
        src: "assets/images/000Z_SeanWIN01.jpg",
      ...
      {
        type: "image",
        src: "assets/images/000Z_SeanWIN02.jpg",
        effect: "cross-dissolve",
        wait: 800,
        skippable: false,
      },
      {
        type: "image",
        src: "assets/images/000Z_SeanWIN03.jpg",
        effect: "cross-dissolve",
        wait: 800,
        skippable: false,
      },
  ...
  playWinAnim(type, wgAdd, callbackMenu) {
    ...
    seq.push({
      type: "image",
      src: `assets/images/000Z_SeanWIN04${type}00.jpg`,
      effect: "cross-dissolve",
      wait: 400,
      skippable: false,
    });
    ...
    for (let i = 0; i < repeats; i++) {
      seq.push({
        type: "image",
        src: `assets/images/000Z_SeanWIN04${type}01.jpg`,
        effect: "cross-dissolve",
        wait: 300,
        skippable: false,
      });
      seq.push({
        type: "image",
        src: `assets/images/000Z_SeanWIN04${type}02.jpg`,
        effect: "cross-dissolve",
        wait: 300,
        skippable: false,
  ...
  winPhase2Menu() {
    return [
      {
        type: "image",
        src: "assets/images/000Z_SeanWIN04.jpg",
        effect: "cross-dissolve",
        wait: 500,
        skippable: false,
      },
  ...
  playWinAnimGS() {
    ...
    seq.push({
      type: "image",
      src: `assets/images/000Z_SeanWIN04gs00.jpg`,
      effect: "cross-dissolve",
      wait: 400,
      skippable: false,
    });
    for (let i = 0; i < 4; i++) {
      seq.push({
        type: "image",
        src: `assets/images/000Z_SeanWIN04gs01.jpg`,
        effect: "cross-dissolve",
        wait: 300,
        skippable: false,
        action: () => {
      ...
      seq.push({
        type: "image",
        src: `assets/images/000Z_SeanWIN04gs02.jpg`,
        effect: "cross-dissolve",
        wait: 200,
        skippable: false,
      });
      seq.push({
        type: "image",
        src: `assets/images/000Z_SeanWIN04gs03.jpg`,
        effect: "cross-dissolve",
        wait: 200,
        skippable: false,
      });
  ...
  winPhase3Menu() {
    return [
      {
        type: "image",
        src: "assets/images/000Z_SeanWIN05.jpg",
        effect: "cross-dissolve",
        wait: 500,
        skippable: false,
      },
  ...
  playWinAnimTSF(type, wbAdd, wgAdd) {
    ...
    seq.push({
      type: "image",
      src: `assets/images/000Z_SeanWIN05${type}00.jpg`,
      effect: "cross-dissolve",
      wait: 400,
      skippable: false,
    });
    ...
    for (let i = 0; i < repeats; i++) {
      seq.push({
        type: "image",
        src: `assets/images/000Z_SeanWIN05${type}01.jpg`,
        effect: "cross-dissolve",
        wait: 200,
        skippable: false,
      ...
      seq.push({
        type: "image",
        src: `assets/images/000Z_SeanWIN05${type}02.jpg`,
        effect: "cross-dissolve",
        wait: 200,
        skippable: false,
      });
  ...
  updateWinState(wbAdd, wgAdd, continueCallback) {
    ...
    if (GAME.state.winState.wg >= 100) {
      GAME.logic.startStory([
        {
          type: "image",
          src: "assets/images/000Z_SeanWIN06ejk01.jpg",
          effect: "cross-dissolve",
          wait: 600,
          skippable: false,
        },
        {
          type: "image",
          src: "assets/images/00Z_SeanWIN06ejk02.jpg",
          effect: "cross-dissolve",
          wait: 600,
          skippable: false,
        },
        {
          type: "image",
          src: "assets/images/00Z_SeanWIN06ejk03.jpg",
          effect: "cross-dissolve",
          wait: 600,
          skippable: false,
        },
        {
          type: "image",
          src: "assets/images/00Z_SeanWIN06ejk04.jpg",
          effect: "cross-dissolve",
          wait: 1000,
          skippable: false,
        },
      ...
      GAME.logic.startStory([
        {
          type: "image",
          src: "assets/images/00Z_SeanWIN07endF01.jpg",
          effect: "cross-dissolve",
          wait: 800,
          skippable: false,
        },
        {
          type: "image",
          src: "assets/images/00Z_SeanWIN07endF02.jpg",
          effect: "cross-dissolve",
          wait: 800,
          skippable: false,
        },
        {
          type: "image",
          src: "assets/images/00Z_SeanWIN07endF03.jpg",
          effect: "cross-dissolve",
          wait: 800,
          skippable: false,
        },
        {
          type: "image",
          src: "assets/images/00Z_SeanWIN07endF04.jpg",
          effect: "cross-dissolve",
          wait: 1000,
          skippable: false,
        },
        {
          type: "image",
          src: "assets/images/00Z_SeanWIN08end01.jpg",
          effect: "cross-dissolve",
          wait: 1000,
          skippable: false,
        },
        ...
        {
          type: "image",
          src: "assets/images/00Z_SeanWIN08end02.jpg",
          effect: "cross-dissolve",
          wait: 1500,
          skippable: false,
        },
